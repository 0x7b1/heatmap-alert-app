...
public class Parameters {
    ...
    public static final Param<String> DATA_TOPIC = Param.string("data-topic", "livetemperatures");
    ...
    // General:
    public static final Param<String> SENSOR_SOURCE = Param.string("data-source", "GENERATOR");
